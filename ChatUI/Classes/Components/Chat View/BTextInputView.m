...
- (id)init
{
    ...
    if (self) {
        ...
        [_optionsButton setImage:[UIImage imageNamed:@"Frameworks/ChatSDK.framework/ChatUI.bundle/icn_24_options.png"] forState:UIControlStateNormal];
        [_optionsButton setImage:[UIImage imageNamed:@"Frameworks/ChatSDK.framework/ChatUI.bundle/icn_24_keyboard.png"] forState:UIControlStateSelected];
